...
4. Implemented support for Gateway Group:
   Please check here [here](https://registry.terraform.io/providers/AviatrixSystems/aviatrix/latest/docs/guides/introduction_to_gateway_group) for more information:
   - New resource: **aviatrix_spoke_ha_gateway**
   - New attributes in **aviatrix_spoke_gateway**:
      - ``manage_ha_gateway``
5. Implemented a new resource to support Distributed Firewalling Config:
...
#### Security
1. Implemented a new resource to support FQDN Global Configs:
   - **aviatrix_fqdn_global_config**

### Enhancements:
1. Updated ``transit_gateway_name`` to optional in **aviatrix_segmentation_network_domain_association**
2. Removed validation for controller IP address during import in **aviatrix_controller_security_group_management_config**
3. Updated **aviatrix_app_domain** to **aviatrix_smart_group**
4. Updated **aviatrix_microseg_policy_list** to **aviatrix_distributed_firewalling_policy_list**
...
2. Removed support for the following attribute from the resources **aviatrix_gateway_snat** and **aviatrix_gateway_dnat**:
   - ``sync_to_ha``
3. Removed support for the following attribute from the resource **aviatrix_gateway** and the data source **aviatrix_gateway**:
   - ``tag_list``
4. Removed support for the following attribute from the resource **aviatrix_transit_gateway** and the data source **aviatrix_transit_gateway**:
   - ``tag_list``
5. Removed support for the following attributes from the resource **aviatrix_spoke_gateway**:
   - ``manage_transit_gateway_attachment``
   - ``transit_gw``
   - ``tag_list``
6. Removed support for the following attributes from the data source **aviatrix_spoke_gateway**:
   - ``transit_gw``
   - ``tag_list``
7. Removed support for the following attributes from the resource **aviatrix_firenet**:
   - ``manage_firewall_instance_association``
   - ``firewall_instance_association``
8. Removed support for the following attributes from the data source **aviatrix_firenet**:
   - ``firewall_instance_association``
9. Removed support for the following attributes from the resource **aviatrix_tgw**:
...
10. Removed support for the following attribute from the resource **aviatrix_aws_tgw_connect**:
    - ``security_domain_name``
11. Removed support for the following attribute from the resource **aviatrix_aws_tgw_directconnect**:
    - ``security_domain_name``
