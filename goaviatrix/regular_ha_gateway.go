...
func (c *Client) CreateRegularHaGw(haGateway *RegularHaGateway) (string, error) {
	haGateway.CID = c.CID
	haGateway.Action = "create_multicloud_ha_gateway"

	return c.PostAPIContext2HaGw(context.Background(), nil, haGateway.Action, haGateway, BasicCheck)
}
