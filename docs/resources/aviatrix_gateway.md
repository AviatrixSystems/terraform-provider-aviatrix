...
* `peering_ha_image_version` - (Optional/Computed) This argument is deprecated and will be removed in an upcoming release. Gateway upgrades can be managed with the `aviatrix_controller_config` resource.
