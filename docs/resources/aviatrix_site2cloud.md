...
* `phase1_remote_identifier` - (Optional) Phase 1 remote identifier of the IPsec tunnel. Example: ["1.2.3.4"] when HA is disabled, ["1.2.3.4", "5.6.7.8"] when HA is enabled. Available as of provider version R2.19+.
