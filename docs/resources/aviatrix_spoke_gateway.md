...
* `enable_vpc_gwlb` - (Optional) Enables CSP gateway load balancer to allow distribution of traffic among the primary and HA spoke gateways. Valid values: true, false. Default value: false.
