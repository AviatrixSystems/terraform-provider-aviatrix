...
SetEnv SKIP_DEVICE_AWS_TGW_ATTACHMENT "no"
SetEnv SKIP_DEVICE_INTERFACE_CONFIG "no"
SetEnv SKIP_DEVICE_REGISTRATION "no"
SetEnv SKIP_DEVICE_TAG "no"
SetEnv SKIP_DEVICE_TRANSIT_GATEWAY_ATTACHMENT "no"
SetEnv SKIP_DEVICE_VIRTUAL_WAN_ATTACHMENT "no"
...
SetEnv SKIP_MICROSEGMENTATION_POLICY_LIST "no"
